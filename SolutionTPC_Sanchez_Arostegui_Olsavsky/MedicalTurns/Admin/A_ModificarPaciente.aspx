             ...
             <div class="main-container">
                ...
                <div class="form-container">
                    ...
                    <div class="generic-form row contanier">
                        ...
                        <asp:Button ID="BtnModificar" CssClass="col-sm-8 col-md-4 m-auto mt-3 BtnSubmit" runat="server" Text="Modificar" OnClientClick="return validateForm()" type="submit" OnClick="BtnModificar_Click"/>     
